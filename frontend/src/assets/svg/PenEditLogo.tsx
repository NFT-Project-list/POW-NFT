...
const PenEditLogo = (props: ownProps): JSX.Element => {
  const { fill } = props;
  ...
  return (
    <svg width="20" height="19" viewBox="0 0 20 19" fill="none">
      <path d="M10 18.1213H19" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path
