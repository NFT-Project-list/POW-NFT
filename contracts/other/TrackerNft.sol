...
contract AnimalColoringBook is ERC721Enumerable, Ownable {
  ...
  constructor(
    ...
    address _gtap1Contract,
    address _wrappedGtap1Contract
  ) ERC721("Animal Coloring Book", "GTAP2") {
  ...
  function mint(address mintTo, bool mintEraser) external payable {
  ...
  function _mint(address mintTo, bool mintEraser) private {
    ...
    uint8 animalType = ((randomNumber < 31 ? 1 : (randomNumber < 56 ? 2 : (randomNumber < 76 ? 3 : (randomNumber < 91 ? 4 : (randomNumber < 99 ? 5 : 6))))));
